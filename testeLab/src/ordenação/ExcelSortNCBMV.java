...
public class ExcelSortNCBMV {
	 public static void main(String[] args) throws IOException {
	        String inputFile = "C:\\projeto java\\ws-eclipse\\ArquivosProjetoOrdenação\\accidents_NCBMV.csv.xlsx";
	        String outputInsertionSortFile1 = "C:\\projeto java\\ws-eclipse\\ArquivosProjetoOrdenação\\accidents_NCBMV_data_insertionSort_melhorCaso.xlsx";
	        String outputInsertionSortFile2 = "C:\\projeto java\\ws-eclipse\\ArquivosProjetoOrdenação\\accidents_NCBMV_time_insertionSort_melhorCaso.csv (1).xlsx";
	        String outputInsertionSortFile3 = "C:\\projeto java\\ws-eclipse\\ArquivosProjetoOrdenação\\accidents_NCBMV_communication_kind_insertionSort_melhorCaso.csv.xlsx";
	     ...
	     // Execução do Counting Sort e impressão do tempo de execução
	        System.out.println("\nOrdenação usando Counting Sort:");
	        double countingSortTimed = CountingSort.sort(dataArray);
	        System.out.println("Tempo de execução da ordenação CountingSort(data): " + countingSortTimed + " segundos");
	        
	        double countingSortTimet = CountingSort.sort(timeArray);
	        System.out.println("Tempo de execução da ordenação CountingSort(time): " + countingSortTimet + " segundos");
	        
	        double countingSortTimec = CountingSort.sort(communicationkindArray);
	        System.out.println("Tempo de execução da ordenação CountingSort(communication_kind): " + countingSortTimec + " segundos");
	        
	     // Execução do Heap Sort e impressão do tempo de execução
	        System.out.println("\nOrdenação usando Heap Sort:");
	        double heapSortTimed = HeapSort.sort(dataArray);
	        System.out.println("Tempo de execução da ordenação HeapSort(data): " +  heapSortTimed + " segundos");
	        
	        double heapSortTimet = HeapSort.sort(timeArray);
	        System.out.println("Tempo de execução da ordenação HeapSort(time): " + heapSortTimet + " segundos");
	        
	        double heapSortTimec = HeapSort.sort(communicationkindArray);
	        System.out.println("Tempo de execução da ordenação HeapSort(communication_kind): " + heapSortTimec + " segundos");
