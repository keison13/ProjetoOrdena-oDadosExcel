...
public class ExcelSortAlcohol {
	 public static void main(String[] args) throws IOException {
	        String inputFile = "C:\\projeto java\\ws-eclipse\\ArquivosProjetoOrdenação\\alcohol_accidents.csv.xlsx";
	        String outputInsertionSortFile1 = "C:\\projeto java\\ws-eclipse\\ArquivosProjetoOrdenação\\alcohol_accidents_data_insertionsort_melhorcaso.xlsx";
	        String outputInsertionSortFile2 = "C:\\projeto java\\ws-eclipse\\ArquivosProjetoOrdenação\\alcohol_accidents_time_insertionSort_melhorCaso.csv.xlsx";
	        String outputInsertionSortFile3 = "C:\\projeto java\\ws-eclipse\\ArquivosProjetoOrdenação\\alcohol_accidents_communication_kind_insertionSort_melhorCaso.csv.xlsx";
